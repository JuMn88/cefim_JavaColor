...
class ColorTest {
    ...
    @BeforeEach
    public void setUp() {
        color = new julien.Color(213, 141, 53);
    }
    ...
    // -------------------------------------
    // Constructor julien.Color(r, g, b)
    @Test
    public void test_constructor_RGB() {
        assertAll("julien.Color object non conformes",
    ...
    public void test_constructor_RGB_with_blue_value_smaller_than_0_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new julien.Color(213, 141, -132));
    }
    ...
    // -------------------------------------
    // Constructor julien.Color(hexValue)
    @Test
    ...
    public void test_constructor_HexValue_with_null_value_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new julien.Color(null));
    }
    ...
    public void test_constructor_HexValue_with_wrong_value_3_Exception() {
        assertThrows(IllegalArgumentException.class, () -> color = new julien.Color("#G26F76"));
    }
